...
- **`search_knowledge`** — `ai_knowledge` дээрх **семантик (вектор) хайлт**.
  Асуултыг embed хийж (`text-embedding-004`, `RETRIEVAL_QUERY`) **pgvector**-ийн
  cosine зайгаар (`embedding <=> $1`, HNSW индекс) тааруулна — өөр үг хэллэгээр
  асуусан ч зөв бүлэг олдоно. `minVectorScore` (0.55)-аас доош таарцыг хаяна:
  зохиосон хариултаас «мэдэхгүй» нь дээр. Embedder тохируулаагүй, embedding
  унасан, эсвэл босго давсан үр дүн гараагүй үед хуучин `ILIKE` түлхүүр үгийн
  хайлт руу уналт хийнэ; tool-ийн хариунд аль горим ажилласныг
  (`"mode": "vector" | "keyword"`) заана. Suurь дүрэм нь model-д платформын
  асуултын *өмнө* үүнийг дуудахыг заадаг.
