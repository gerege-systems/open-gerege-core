...
- **Хариултын хэл** нь хүсэлтийн `lang`-аас (frontend UI-ийн хэлээ илгээнэ:
  ...
  туслах түүнийг дагана. `degraded` fallback мессеж ч мөн адил хэлээрээ ирнэ.
  Дүрмийг prompt-ын төгсгөлд `[ХЭЛ / LANGUAGE]` хэсгээр, *тухайн хэл дээрээ*
  давтана — prompt бүхэлдээ монголоор бичигдсэн тул энэ нь model-ыг буцаж
  монгол руу татагдахаас сэргийлнэ.
