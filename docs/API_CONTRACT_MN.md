...
**Нэвтрэлт шаардахгүй.** Ижил body, гэхдээ хариултыг **Server-Sent Events**
(`text/event-stream`)-ээр хэсэг хэсгээр нь өгнө — нүүрийн виджет үүнийг
хэрэглэнэ. Дуут мессежийг **НЭГ** Gemini дуудалтаар шийднэ: model нэг дор
хуулбарлаж, хариулна (тусдаа STT дуудалт байхгүй).

| Event | Payload | Утга |
|-------|---------|------|
| `transcript` | `{"text": "…"}` | дуут мессежийн хуулбар (нэг удаа, хариултаас өмнө) |
| `delta` | `{"text": "…"}` | хариултын дараагийн хэсэг |
| `reset` | `{}` | одоог хүртэлх delta-г хаях (model tool дуудахаасаа өмнө бичсэн) |
| `done` | `{"degraded": false, "transcript": "…"}` | урсгалын төгсгөл |
| `error` | `{"message": "…"}` | толгой явсны дараа урсгал тасарсан |

Хариунд `X-Accel-Buffering: no` тавигдана — эс бөгөөс урд талын proxy урсгалыг
цуглуулаад нэг дор өгнө. Rate limit, payload хязгаар, tool багц, guardrail нь
`/public/ai/chat`-тай ижил.
