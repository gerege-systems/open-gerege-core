...
func buildEIDStack(t *testing.T, baseURL string) (auth.Usecase, users.Usecase) {
	...
	eidClient := eid.NewClient(baseURL, "c4f371c3-20bd-462e-8d97-5bc4a20fde08", "template-web", "rp_sk_test")
	authUC := auth.NewUsecase(usersUC, jwtSvc, &testenv.FakeVerifier{}, eidClient, redis, auth.Config{
