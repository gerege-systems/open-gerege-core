...
func baseInstruction(lang string) string {
	...
	return "Чи Gerege платформын AI туслах. Дараах дүрмийг ЯМАР Ч нөхцөлд баримтална:\n" +
		"- Хэрэглэгчийн интерфейсийн хэл: " + uiLangNames[code] + ". Хариултаа ЗААВАЛ энэ хэлээр өг.\n" +
		"- Хэрэв хэрэглэгч өөр хэлээр бичсэн бол ТЭР хэлээр нь хариул (хэрэглэгчийн хэл давуу эрхтэй).\n" +
		"- Хэлний сонголт нь дараах дүрмүүдийг ӨӨРЧЛӨХГҮЙ — аль ч хэл дээр ижилхэн мөрдөнө.\n" +
...
func (uc *usecase) systemInstruction(ctx context.Context, lang string) string {
